...
void
ecrdot_ (float *Pxctr, float *Pyctr, float *Prcrc)
                             

/*
 *     ecrdot : trace d'un cercle plein (point)
 *     version %I% du %G%
 */
...
/* .... ecriture du cercle ............................*/
      ...
      zm_rid (PSimg, jxctr, jxccft, jyccft, npnt2+1, kcol);
      zm_rid (PSimg, jxctr, &jxccft[npnt2], &jyccft[npnt2], npnt2+1, kcol);
}
E 1
