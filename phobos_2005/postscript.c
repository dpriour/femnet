...
void Chk_ps_open()
	...
	//sprintf(nom_fichier_ps,"%s.ps",fname1);
	snprintf(nom_fichier_ps, sizeof(nom_fichier_ps), "%s.ps", fname1);	
	printf("fname1 : %s\n",fname1);	
	printf("nom_fichier_ps : %s\n",nom_fichier_ps);	
	printf("mode_portrait : %d\n",mode_portrait);	
	
	/*strcpy(nom_fichier_ps,"batz.ps");*/
	...
	fprintf(fic_ps,"\n\n\n\n");		
		{
		int i,j,k,x,y,offset_x,offset_y;
		short c;
